...
#pragma warning restore CA1001 // Types that own disposable fields should be disposable
    {
        ...
        public async Task DoOperationsAsync()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                global::Azure.Response<MyDocument> storedDoc = await this.cosmosContainer.ReadItemAsync<MyDocument>(i.ToString(), new Cosmos.PartitionKey(i.ToString()));
                Assert.IsNotNull(storedDoc.Value);
            }
